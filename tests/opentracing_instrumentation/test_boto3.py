...
@mock.patch.object(boto3_hooks, '_service_action_call')
@mock.patch.object(boto3_hooks, 'ServiceAction', __call__=None)
def test_install_patches_skip(service_action_mock, *mocks):
    del boto3_hooks._service_action_call
    boto3_hooks.reset_patches()
    boto3_hooks.install_patches()
    assert service_action_mock.__call__ is None
